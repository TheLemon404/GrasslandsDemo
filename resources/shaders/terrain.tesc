...
void main() {
    ...
    if (gl_InvocationID == 0)
    {
        ...
        vec4 eyeSpacePos00 = transformationData.view * transformationData.transform * gl_in[0].gl_Position;
        vec4 eyeSpacePos01 = transformationData.view * transformationData.transform * gl_in[1].gl_Position;
        vec4 eyeSpacePos10 = transformationData.view * transformationData.transform * gl_in[2].gl_Position;
        vec4 eyeSpacePos11 = transformationData.view * transformationData.transform * gl_in[3].gl_Position;
